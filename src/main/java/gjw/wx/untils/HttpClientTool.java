...
public class HttpClientTool {
    ...
    public static String doPostFrom(String url, Map<String, String> params) throws IOException {
        return doPostFrom(url, params, CHARSET);
    }
     ...
     * @throws IOException
     */
    public static String doPostFrom(String url, Map<String, String> params, String charset)
            throws IOException {
        if (StringUtils.isBlank(url)) {
            return null;
        }
